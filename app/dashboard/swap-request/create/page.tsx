...
export default function CreateSwapRequestPage() {
  ...
  return (
    <div className="pl-6 pr-6 h-screen">
      ...
      {phase === 1 ? (
        <Firstpage phase={phase} setPhase={setphase} setfromsession={setfromSession} settosession={settoSession} />
      ) : phase === 2 ? (
        <Secondpage phase={phase} setPhase={setphase} setfromsession={setfromSession} settosession={settoSession}  fromsession={fromSession} tosession={toSession}/>
      ) : null}
      </div>
